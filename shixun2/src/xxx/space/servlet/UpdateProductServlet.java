...
//		System.out.println(selling_description);
		...
		Product product = new Product(id, name, cate_id, thumbnail,inventory, sales_volume, price, sale_price, detail_description, selling_description, create_time, sale_time);
