	...
	<aside id="left-panel" class="left-panel">
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="./"><img src="images/logo.png" alt="Logo"></a> <a
					class="navbar-brand hidden" href="./"><img src="images/logo2.png" alt="Logo"></a>
			</div>

			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li><a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Dashboard
						</a></li>
					<h3 class="menu-title">UI elements</h3>
					<!-- /.menu-title -->
					<li class="menu-item-has-children dropdown"><a href="#" class="dropdown-toggle"
	...
	<div id="right-panel" class="right-panel">
					...
					<div class="header-left">
						...
						<div class="dropdown for-notification">
							...
							<div class="dropdown-menu" aria-labelledby="notification">
								...
								<a class="dropdown-item media bg-flat-color-1" href="#"> <i class="fa fa-check"></i>
									<p>Server #1 overloaded.</p>
								</a> <a class="dropdown-item media bg-flat-color-4" href="#"> <i class="fa fa-info"></i>
						...
						<div class="dropdown for-message">
							...
							<div class="dropdown-menu" aria-labelledby="message">
								...
								<a class="dropdown-item media bg-flat-color-1" href="#"> <span
										class="photo media-left"><img alt="avatar" src="images/avatar/1.jpg"></span>
									<span class="message media-body"> <span class="name float-left">Jonathan
											Smith</span> <span class="time float-right">Just now</span>
										<p>Hello, this is an example msg</p>
									</span>
								</a> <a class="dropdown-item media bg-flat-color-4" href="#"> <span
										class="photo media-left"><img alt="avatar" src="images/avatar/2.jpg"></span>
									<span class="message media-body"> <span class="name float-left">Jack Sanders</span>
										<span class="time float-right">5 minutes ago</span>
										<p>Lorem ipsum dolor sit amet, consectetur</p>
									</span>
								</a> <a class="dropdown-item media bg-flat-color-5" href="#"> <span
										class="photo media-left"><img alt="avatar" src="images/avatar/3.jpg"></span>
									<span class="message media-body"> <span class="name float-left">Cheryl
											Wheeler</span> <span class="time float-right">10 minutes ago</span>
										<p>Hello, this is an example msg</p>
									</span>
								</a> <a class="dropdown-item media bg-flat-color-3" href="#"> <span
										class="photo media-left"><img alt="avatar" src="images/avatar/4.jpg"></span>
									<span class="message media-body"> <span class="name float-left">Rachel Santos</span>
				...
				<div class="col-sm-5">
					<div class="user-area dropdown float-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <img class="user-avatar rounded-circle" src="images/admin.jpg"
								alt="User Avatar">
						</a>
						...
						<div class="user-menu dropdown-menu">
							<a class="nav-link" href="#"><i class="fa fa-user"></i> My
								...
								Notifications <span class="count">13</span></a> <a class="nav-link" href="#"><i
					...
					<div class="language-select dropdown" id="language-select">
						<a class="dropdown-toggle" href="#" data-toggle="dropdown" id="language" aria-haspopup="true"
							aria-expanded="true"> <i class="flag-icon flag-icon-us"></i>
						</a>
						...
						<div class="card">
							<div class="card-header">
								...
								<button type="button" style="float:right"
									onclick="javascrtpt:window.location.href='Add_Prepare'"
							...
							<div class="card-body">
								<table class="table table-striped table-bordered">
									...
									<tbody>
										<c:forEach items="${pageBean1.lists}" var="product">
											<tr>
												<td> <img src="update/${product.thumbnail }" alt="照片不存在" width="90"
														height="90" /></td>
												<td style="width:100px">${product.name }</td>
												<td style="width:70px">${product.inventory }</td>
												<td style="width:70px">${product.sales_volume }</td>
												<td>${product.price}</td>
												...
												<td>
													<div>${product.selling_description }</div>
												</td>
												<td>${product.create_time }</td>
												<td>${product.sale_time}</td>
												<td style="width:80px"><a href="#" onclick="del(${product.id},${pageBean1.currentPage})">
														<i class="fa fa-trash-o">
														</i>
														删除
													</a><br>
													<a href="${pageContext.request.contextPath}/prodect_detail?product_id=${product.id}" title="编辑" ><i class="fa fa-pencil-square-o"></i>编辑 </a>
													</td>
											</tr>
										</c:forEach>
								...
								<ul>
									<li><a
											href="${pageContext.request.contextPath }/product_page?currentPage=${pageBean1.currentPage==1?1:pageBean1.currentPage-1}&pageSize=5">&lt;&lt;上一页</a>
										第${pageBean1.currentPage}页/共${pageBean1.totalPage }页
										<a
											href="${pageContext.request.contextPath }/product_page?currentPage=${pageBean1.currentPage==pageBean1.totalPage?pageBean1.totalPage:pageBean1.currentPage+1}&pageSize=5">下一页&gt;&gt;</a>
									</li>
								</ul>
		...
		<script type="text/javascript">
			function del(id,currentPage) {
				if (confirm("确认删除？")) {
					window.location.href = "delete_product?product_id=" + id+ "&currentPage="+currentPage;
				}
			}
		</script>
