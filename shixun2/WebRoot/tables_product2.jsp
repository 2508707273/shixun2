					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header" >
								...
								<button type="button" style="float:right" onclick="javascrtpt:window.location.href='Add_Prepare'" class="btn btn-primary">增加</button>
							</div>
							<div class="card-body">
								<table 
								...
								<ul>
									<li><a href="${pageContext.request.contextPath }/product_page?currentPage=${pageBean1.currentPage==1?1:pageBean1.currentPage-1}&pageSize=5">&lt;&lt;上一页</a>
										第${pageBean1.currentPage}页/共${pageBean1.totalPage }页
										 <a href="${pageContext.request.contextPath }/product_page?currentPage=${pageBean1.currentPage==pageBean1.totalPage?pageBean1.totalPage:pageBean1.currentPage+1}&pageSize=5">下一页&gt;&gt;</a>
									</li>
								</ul>
